...
let
    ...
    debug                   = require('debug')('GenNode Authorization/controller/user'),
    async                   = require('async');
...
exports.find            = function (req, res, next) {
    ...
    if(req.query._id !== undefined) {
        ...
        let option = {
            ...
            select   : "name phone email type userId firstModified lastModified"
        };

        let query = controllerHelper.queryFilter(req,["name", "phone", "email", "type", "userId", "_id", "__v"]);
...
exports.update          = function (req, res, next) {
    ...
    function pickUpdateData (callback)                  {
        ...
        controllerHelper.pickUpdateData(["name", "phone", "email", "type", "userId"],req,function (err,validUpdateData) { // Picking up valid update data.
